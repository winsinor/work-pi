...
LAYOUT_DEFAULTS: dict = {
    ...
    "icon":    {"radius": 76, "gap": 7, "x": 260, "y": 80},
    "aqi":     {"cx": 154, "y": 12, "label_size": 15, "value_size": 25},
    "grid":    {"height": 65, "columns": 5,
                "label_size": 13, "temp_size": 17, "rain_size": 13,
                "hum_size": 8, "wind_size": 8},
